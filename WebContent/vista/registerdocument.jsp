...
<html lang="en">
	<head>
		<title>CSID - Registrar Documento</title>
		<meta charset="utf-8">
	...
	<body>
		<div class="container pt-5">
			...
			<div class="container p-3 my-3 bg-dark text-white">
				<form action="AdminDocumento?action=register&CUI=${CUI}" class="needs-validation" method="post" onsubmit="return validateForm()" novalidate>
					<div class="form-row">
						...
						<div class="col-md-4 mb-3">
							...
							<input type="text" class="form-control is-valid" id="validationCustomDate" placeholder="yyyy-mm-dd" required name="fechadoc" >
						...
						<div class="col-md-4 mb-3">
							...
							<input type="text" class="form-control is-valid" id="validationSerialNumber" placeholder="Número de serie" maxlength="45" required name="nroserie">
							<div class="invalid-feedback">
					...
					<div class="col-md-4 mb-3">
							...
							<input type="text" class="form-control is-valid" id="validationLink" placeholder="Link" maxlength="45" required name="direcciondoc">
							<div class="invalid-feedback">
